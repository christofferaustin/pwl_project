            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow rounded-4">
                    ...
                    <div class="card-header bg-white py-4 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-1">Detail Dosen</h3>
                            <small class="text-muted">Informasi lengkap data dosen.</small>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table table-borderless mb-0">
                            <tr><th width="220">Nama Lengkap</th><td>: {{ $dosen->Fullname }}</td></tr>
                            <tr><th>NIP</th><td>: {{ $dosen->NIP }}</td></tr>
                            <tr><th>NIDN</th><td>: {{ $dosen->NIDN }}</td></tr>
                            <tr><th>Pendidikan Terakhir</th><td>: {{ $dosen->Pendidikan_Terakhir }}</td></tr>
                            <tr><th>Jurusan</th><td>: {{ $dosen->jurusan->Nama_Jurusan ?? '-' }}</td></tr>
                            <tr><th>Tempat, Tanggal Lahir</th><td>: {{ $dosen->Tempat_Lahir }}, {{ \Carbon\Carbon::parse($dosen->Tanggal_Lahir)->format('d M Y') }}</td></tr>
