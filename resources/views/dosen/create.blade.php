...
<head>
    ...
    <title>Tambah Dosen - SIAKAD ITBSS</title>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow rounded-4">
                ...
                <div class="card-header bg-white py-4 border-bottom d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="fw-bold mb-1">Tambah Dosen Baru</h3>
                        <small class="text-muted">Isi formulir di bawah ini dengan data yang valid.</small>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('Pendidikan_Terakhir') is-invalid @enderror" id="Pendidikan_Terakhir" name="Pendidikan_Terakhir" required>
                                    ...
                                    <option value="Prof" {{ old('Pendidikan_Terakhir') == 'Prof' ? 'selected' : '' }}>Profesor</option>
                                </select>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                                    <option value="" selected>-- Belum Ditautkan --</option>
