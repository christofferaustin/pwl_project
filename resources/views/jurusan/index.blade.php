...
<head>
    ...
    <title>Data Jurusan - SIAKAD ITBSS</title>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Kelola seluruh data jurusan Institut Teknologi & Bisnis Sabda Setia.
        ...
        <a href="{{ action([App\Http\Controllers\JurusanController::class,'create']) }}"
           class="btn btn-primary rounded-3 px-4 py-2 fw-semibold shadow-sm d-inline-flex align-items-center gap-2">
                    ...
                    <tbody>                        @forelse($jurusan as $j)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <a href="{{ action([App\Http\Controllers\JurusanController::class,'show'],[$j->id]) }}"
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="text-center text-muted py-5">
                                ...
                                Belum ada data jurusan terdaftar dalam sistem.
