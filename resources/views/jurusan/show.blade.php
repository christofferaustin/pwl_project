...
<html lang="en">
    ...
    <title>Jurusan - SIAKAD ITBSS</title>
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow rounded-4">
                    ...
                    <div class="card-header bg-white py-4 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-1">Detail Jurusan</h3>
                            <small class="text-muted">Informasi lengkap data jurusan.</small>
                        </div>

                        <a href="{{ route('jurusan.index') }}" class="btn btn-outline-secondary btn-sm">Kembali</a>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table table-borderless mb-0">
                            <tr><th width="220">Kode Jurusan</th><td>: {{ $jurusan->Kode_Jurusan }}</td></tr>
