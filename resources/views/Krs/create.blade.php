                ...
                <div class="card border-0 shadow rounded-4">
                    ...
                    <div class="card-header bg-white py-4 border-bottom">
                        ...
                        <small class="text-muted">
                            Lengkapi data KRS mahasiswa di bawah ini.
                        </small>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ action([App\Http\Controllers\KRSController::class,'store']) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $mahasiswa->NIM }} - {{ $mahasiswa->Fullname }}"
                                        disabled>

                                    <small class="text-muted">
                                        KRS ini otomatis dibuat atas nama akun kamu yang login.
                                    </small>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ action([App\Http\Controllers\KRSController::class,'index']) }}"
