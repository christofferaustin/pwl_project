...
<html lang="en">
    ...
    <title>Approval KRS - SIAKAD ITBSS</title>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <p class="text-muted">
                    Daftar pengajuan mata kuliah yang menunggu persetujuan dosen.
                </p>
            </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->krs->mahasiswa->Fullname }}</td>
                                ...
                                <td>
                                    ...
                                    @if($item->status=='pending')
                                        ...
                                        <form action="{{ route('krsdetail.approve',$item->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <form action="{{ route('krsdetail.reject',$item->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Belum ada pengajuan KRS.</td>
                            </tr>
