    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <p class="text-muted">
                    Kelola seluruh data mata kuliah Institut Teknologi & Bisnis Sabda Setia.
                </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="{{ action([App\Http\Controllers\MataKuliahController::class,'destroy'],[$mk->id]) }}"
                                              method="POST"
