                ...
                <div class="card border-0 shadow rounded-4">
                    ...
                    <div class="card-header bg-white py-4 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Informasi lengkap data mata kuliah.</small>
                        </div>

                        <a href="{{ route('matakuliah.index') }}" class="btn btn-outline-secondary btn-sm">Kembali</a>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table table-borderless mb-0">
                            <tr><th width="220">Kode Mata Kuliah</th><td>: {{ $matakuliah->Kode_Mata_Kuliah }}</td></tr>
                            <tr><th>Nama Mata Kuliah</th><td>: {{ $matakuliah->Nama_Mata_Kuliah }}</td></tr>
                            <tr><th>SKS</th><td>: {{ $matakuliah->SKS }}</td></tr>
                            <tr><th>Jurusan</th><td>: {{ $matakuliah->jurusan->Nama_Jurusan ?? '-' }}</td></tr>
                            <tr><th>Dosen Pengampu</th><td>: {{ $matakuliah->dosen->Fullname ?? '-' }}</td></tr>
                        </table>
