                ...
                <div class="card border-0 shadow rounded-4">
                    ...
                    <div class="card-header bg-white py-4 border-bottom">
                        ...
                        <small class="text-muted">
                            Lengkapi data jadwal kuliah di bawah ini.
                        </small>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ action([App\Http\Controllers\KelasController::class,'store']) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        name="jumlah_max"
                                        placeholder="Masukkan jumlah maksimum mahasiswa"
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ action([App\Http\Controllers\KelasController::class,'index']) }}"
