...
<head>
    ...
    <title>Data Kelas - SIAKAD ITBSS</title>
                    ...
                    <tbody>                        @forelse($kelas as $k)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex justify-content-center gap-2 flex-wrap">
                                    ...
                                    <a href="{{ action([App\Http\Controllers\KelasController::class,'show'],[$k->id]) }}"
                        ...
                        <tr>
                            ...
                            <td colspan="9"
                                ...
                                <i class="bi bi-calendar-x display-5 text-secondary d-block mb-3"></i>
                                ...
                                <p class="text-muted mb-0">
                                    ...
                                    Silakan tambahkan data jadwal kuliah terlebih dahulu.
